...
This repository is based on the rails-core [vagrant box](https://github.com/rails/rails-dev-box) repository
...
Building the virtual machine is this easy:
    ...
    host $ git clone git@github.com:ljrzarate/vagrant-rails.git
